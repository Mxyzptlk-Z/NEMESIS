...
from devlib.market.curves.cme_term_sofr_curve import CmeTermSofr3M
...
mkt_file_path = './unit_test/data/tsfr3m_curve_data_20240709.xlsx'
...
curve = QLCurve(value_dt, tsfr3m_curve, dc_type=DayCountTypes.ACT_360, interp_type=InterpTypes.LINEAR_ZERO_RATES)
