...
from devlib.market.curves.cme_term_sofr_curve import CmeTermSofr6M
...
mkt_file_path = './unit_test/data/tsfr6m_curve_data_20240709.xlsx'
...
tsfr6m_curve = CmeTermSofr6M(today, deposit_mkt_data=deposit_mkt_data,
                             base_curve_swap_mkt_data=base_curve_swap_mkt_data)

index_name = 'TSFR6M'
index_curve = tsfr6m_curve
discount_curve = tsfr6m_curve
...
multiplier = 1
spread = 0
fixed_leg_pay_freq = '6M'
float_leg_pay_freq = '6M'
...
curve = QLCurve(value_dt, tsfr6m_curve, dc_type=DayCountTypes.ACT_360, interp_type=InterpTypes.LINEAR_ZERO_RATES)
