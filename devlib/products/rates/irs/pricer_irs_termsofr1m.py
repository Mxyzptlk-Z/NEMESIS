...
from market.curves.cme_term_sofr_curve import CmeTermSofr1M
...
mkt_file_path = parant_folder_path + '/market/curves/market_data/tsfr1m_curve_data_20240709.xlsx'
...
print("-----------------------------------------------------")
print('Curve result:')
curve_result = curve_test(tsfr1m_curve)
...
#%%
print("-----------------------------------------------------")
print('IRS example compared to old model:')

today = ql.Date(6, 1, 2023)
ql.Settings.instance().evaluationDate = today

mkt_file_path = parant_folder_path + '/market/curves/market_data/tsfr1m_curve_data_20230106.xlsx'
deposit_mkt_data = pd.read_excel(mkt_file_path, sheet_name='deposit')
base_curve_swap_mkt_data = pd.read_excel(mkt_file_path, sheet_name='base_curve_swap')
...
effective_date = ql.Date(6, 1, 2023)
