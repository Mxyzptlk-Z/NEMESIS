...
from market.curves.cme_term_sofr_curve import CmeTermSofr6M
...
mkt_file_path = parant_folder_path + '/market/curves/market_data/tsfr6m_curve_data_20240709.xlsx'
...
print("-----------------------------------------------------")
print('Curve result:')
curve_result = curve_test(tsfr6m_curve)
