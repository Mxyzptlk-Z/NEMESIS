# -*- coding: utf-8 -*-
"""
Created on Thu Jun  6 14:40:30 2024
...
from products.fx import fx_knock
...
#%% 
# pricer example 1 (coupon=0)
print('\nPricer example 1:')
# trade info
d_ccy = 'CNY'
f_ccy = 'USD'
calendar = get_calendar(f_ccy, d_ccy)
expiry = ql.Date(17,1,2023)
...
forward_curve_file = parent_folder_path + r'\market\curves\market_data\USDCNY_curve_data_20210820.xlsx'
...
## d_curve
d_curve_file = parent_folder_path + r'\market\curves\market_data\shibor3m_curve_data_20210820.xlsx'
...
## vol_surface
vol_surface_file = parent_folder_path + r'\market\volatility\market_data\USDCNY_vol_data_20210820.xlsx'
...
#%% 
# pricer example 2 (cash settle d_ccy coupon)
print('\nPricer example 2:')
# trade info
d_ccy = 'CNY'
f_ccy = 'USD'
...
trade_direction = 'long'
coupon = 3e4
coupon_cash_settle = True

inst = fx_knock.FxKnock(d_ccy, f_ccy, calendar, expiry, payment_date, 
                        barrier_type, barrier, barrier_at_coupon, flavor, strike,
                        notional, notional_ccy, trade_direction, coupon, coupon_cash_settle)
